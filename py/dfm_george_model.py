...
def generate_data(params, N, rng=(-5, 5)):
    gp = george.GP(0.3 * kernels.ExpSquaredKernel(3.3))
...
if __name__ == "__main__":
    ...
    pl.savefig("../figs/data_dfm.pdf", dpi=150)
    ...
    pl.savefig("../figs/gp-results_dfm.pdf", dpi=150)

    # Make the corner plot.
    fig = corner.corner(samples[:, 2:], truths=truth, labels=labels)
    fig.savefig("../figs/gp-corner_dfm.pdf", dpi=150)
